    ...
    <div class="ratings-content">
      ...
      <div class="ratingselect">
        <div class="rating-type border-1px">
          <span class="block positive " @click="SelectType(2)" :class="{active: selectedType===2}">
              全部<span class="count">{{ratings.length}}</span>
          </span>
          <span class="block positive" @click="SelectType(0)" :class="{active: selectedType===0}">
            满意<span class="count">{{PositiveSize}}</span>
          </span>
          <span class="block negative" @click="SelectType(1)" :class="{active: selectedType===1}">
          不满意<span class="count">{{ratings.length-PositiveSize}}</span>
          </span>
        </div>
        <div class="switch " :class="{on: onlyShowText}" @click="toggleShowText">
          <span class="iconfont icon-login_icon_check-circled"></span>
